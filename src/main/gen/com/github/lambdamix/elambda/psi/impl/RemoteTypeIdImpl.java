...
public class RemoteTypeIdImpl extends ASTWrapperPsiElement implements RemoteTypeId {

  public RemoteTypeIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ELambdaVisitor visitor) {
    visitor.visitRemoteTypeId(this);
  }
