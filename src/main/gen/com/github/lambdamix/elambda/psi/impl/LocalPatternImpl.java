...
public class LocalPatternImpl extends ASTWrapperPsiElement implements LocalPattern {

  public LocalPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ELambdaVisitor visitor) {
    visitor.visitLocalPattern(this);
  }
  ...
  @Override
  public @NotNull LocalPatternReference getReference() {
